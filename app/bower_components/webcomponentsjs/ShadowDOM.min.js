...
"undefined" == typeof WeakMap && !function () {
    ...
    function d(e) {
        return A && p(e) ? new Function("return this.__impl4cf1e782hg__." + e) : function () {
            return this.__impl4cf1e782hg__[e]
        }
    }

    function f(e) {
        return A && p(e) ? new Function("v", "this.__impl4cf1e782hg__." + e + " = v") : function (t) {
            this.__impl4cf1e782hg__[e] = t
        }
    }

    function h(e) {
        return A && p(e) ? new Function("return this.__impl4cf1e782hg__." + e + ".apply(this.__impl4cf1e782hg__, arguments)") : function () {
    ...
    function m(t, n, r) {
        for (var o = k(t), i = 0; i < o.length; i++) {
            var a = o[i];
            if ("polymerBlackList_" !== a && !(a in n || t.polymerBlackList_ && t.polymerBlackList_[a])) {
                U && t.__lookupGetter__(a);
                var s, c, u = w(t, a);
                if (r && "function" == typeof u.value)n[a] = h(a); else {
                    var p = l(a);
                    s = p ? e.getEventHandlerGetter(a) : d(a), (u.writable || u.set || V) && (c = p ? e.getEventHandlerSetter(a) : f(a));
                    var m = V || u.configurable;
                    I(n, a, {get: s, set: c, configurable: m, enumerable: u.enumerable})
                }
            }
        }
    }
    ...
    function T(e) {
        return null === e ? null : (n(M(e)), e.__wrapper8e3dd93a60__ || (e.__wrapper8e3dd93a60__ = new (s(e))(e)))
    }
    ...
    var R = new WeakMap, P = new WeakMap, W = Object.create(null), A = t(), I = Object.defineProperty, k = Object.getOwnPropertyNames, F = Object.getOwnPropertyDescriptor, B = {
        value: void 0,
        configurable: !0,
        enumerable: !1,
        writable: !0
    ...
    function s(e, t) {
        ...
        for (var n = I(t), r = e[0], o = I(r), i = u(n, o), a = 0; a < e.length; a++) {
            var s = e[a];
            if (I(s) === i)return s
        }
        return e[e.length - 1]
    ...
    function l(e, t, n) {
        t instanceof G.Window && (t = t.document);
        var o, i = I(t), a = I(n), s = r(n, e), o = u(i, a);
        o || (o = a.root);
    ...
    function d(e) {
        if (!z.get(e) && (z.set(e, !0), h(V(e), V(e.target)), W)) {
            var t = W;
            throw W = null, t
        }
    }
    ...
    function h(t, n) {
        ...
        return nt.set(t, o), w(t, o, a, i) && m(t, o, a, i) && g(t, o, a, i), J.set(t, rt), $["delete"](t, null), K["delete"](t), t.defaultPrevented
    }
    ...
    function g(e, t, n, r) {
        for (var o = at, i = 1; i < t.length; i++)if (!v(t[i], e, o, t, r))return;
    ...
    function v(e, t, n, r, o) {
        ...
        for (var w = 0, m = i.length; m > w; w++) {
            var g = i[w];
            if (g.removed)h = !0; else if (!(g.type !== f || !g.capture && n === ot || g.capture && n === at))try {
                if ("function" == typeof g.handler ? g.handler.call(e, t) : g.handler.handleEvent(t), et.get(t))return !1
            } catch (v) {
                W || (W = v)
            }
        }
    ...
    function y(e, t) {
        ...
        var n = e;
        return vt || "beforeunload" !== n.type || this instanceof O ? void B(n, this) : new O(n)
    }
    ...
    function T(e, t, n, r) {
        if (mt)return new e(n, E(r));
        var o = q(document.createEvent(t)), i = wt[t], a = [n];
    ...
    function D(e, t) {
        for (var n = q(e); n; n = n.parentNode)if (C(V(n), t))return !0;
        return !1
    }
    ...
    var W, A = e.forwardMethodsToWrapper, I = e.getTreeScope, k = e.mixin, F = e.registerWrapper, B = e.setWrapper, U = e.unsafeUnwrap, q = e.unwrap, V = e.wrap, G = e.wrappers, X = (new WeakMap, new WeakMap), z = new WeakMap, K = new WeakMap, Y = new WeakMap, $ = new WeakMap, Z = new WeakMap, J = new WeakMap, Q = new WeakMap, et = new WeakMap, tt = new WeakMap, nt = new WeakMap, rt = 0, ot = 1, it = 2, at = 3;
    b.prototype = {
        equals: function (e) {
    ...
    var ct = S("UIEvent", y), ut = S("CustomEvent", y), lt = {
        get relatedTarget() {
            var e = Z.get(this);
            return void 0 !== e ? e : V(q(this).relatedTarget)
        }
    }, pt = k({initMouseEvent: M("initMouseEvent", 14)}, lt), dt = k({initFocusEvent: M("initFocusEvent", 5)}, lt), ft = S("MouseEvent", ct, pt), ht = S("FocusEvent", ct, dt), wt = Object.create(null), mt = function () {
        try {
    ...
    if (!mt) {
        ...
        gt("Event", {
            bubbles: !1,
            cancelable: !1
        }), gt("CustomEvent", {detail: null}, "Event"), gt("UIEvent", {
            view: null,
            detail: 0
        }, "Event"), gt("MouseEvent", {
            screenX: 0,
            ...
            button: 0,
            relatedTarget: null
        }, "UIEvent"), gt("FocusEvent", {relatedTarget: null}, "UIEvent")
    }
    var vt = window.BeforeUnloadEvent;
    ...
    [Node, Window].forEach(function (e) {
        ...
        addEventListener: function (e, t, n) {
            if (L(t) && !j(e)) {
                var r = new b(e, t, n), o = X.get(this);
                if (o) {
                    for (var i = 0; i < o.length; i++)if (r.equals(o[i]))return
                } else o = [], o.depth = 0, X.set(this, o);
                o.push(r);
                var a = _(this);
    ...
    e.elementFromPoint = x, e.getEventHandlerGetter = R, e.getEventHandlerSetter = P, e.wrapEventTargetMethods = H, e.wrappers.BeforeUnloadEvent = O, e.wrappers.CustomEvent = ut, e.wrappers.Event = y, e.wrappers.EventTarget = N, e.wrappers.FocusEvent = ht, e.wrappers.MouseEvent = ft, e.wrappers.UIEvent = ct
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e, t) {
    ...
    function g(e) {
        if (e.invalidateShadowRenderer()) {
            for (var t = e.firstChild; t;) {
                ...
                o && K.call(o, r), t.previousSibling_ = t.nextSibling_ = t.parentNode_ = null, t = n
            }
            e.firstChild_ = e.lastChild_ = null
        } else for (var n, i = W(e), a = i.firstChild; a;)n = a.nextSibling, K.call(i, a), a = n
    }
    ...
    function y(e, t, n) {
        var r;
        if (r = I(n ? U.call(n, P(e), !1) : q.call(P(e), !1)), t) {
    ...
    function S(e) {
        L(e instanceof V), M.call(this, e), this.parentNode_ = void 0, this.firstChild_ = void 0, this.lastChild_ = void 0, this.nextSibling_ = void 0, this.previousSibling_ = void 0, this.treeScope_ = void 0
    }

    var M = e.wrappers.EventTarget, T = e.wrappers.NodeList, O = e.TreeScope, L = e.assert, j = e.defineWrapGetter, N = e.enqueueMutation, _ = e.getTreeScope, C = e.isWrapper, D = e.mixin, H = e.registerTransientObservers, x = e.registerWrapper, R = e.setTreeScope, P = e.unsafeUnwrap, W = e.unwrap, A = e.unwrapIfNeeded, I = e.wrap, k = e.wrapIfNeeded, F = e.wrappers, B = !1, U = document.importNode, q = window.Node.prototype.cloneNode, V = window.Node, G = window.DocumentFragment, X = (V.prototype.appendChild, V.prototype.compareDocumentPosition), z = V.prototype.insertBefore, K = V.prototype.removeChild, Y = V.prototype.replaceChild, $ = /Trident|Edge/.test(navigator.userAgent), Z = $ ? function (e, t) {
        try {
            K.call(e, t)
        } catch (n) {
    ...
    S.prototype = Object.create(M.prototype), D(S.prototype, {
        appendChild: function (e) {
            ...
            t(e);
            var r;
            n ? C(n) ? r = W(n) : (r = n, n = I(r)) : (n = null, r = null), n && L(n.parentNode === this);
            var o, s = n ? n.previousSibling : this.lastChild, c = !this.invalidateShadowRenderer() && !v(e);
            if (o = c ? a(e) : i(e, this, s, n), c)f(this, e), m(this), z.call(P(this), W(e), r); else {
                ...
                u ? z.call(u, w(this, o), r) : h(this, o)
            }
            return N(this, "childList", {addedNodes: o, nextSibling: n, previousSibling: s}), l(o, this), e
            ...
            if (this.invalidateShadowRenderer()) {
                ...
                l && Z(l, i), c === e && (this.firstChild_ = a), u === e && (this.lastChild_ = s), s && (s.nextSibling_ = a), a && (a.previousSibling_ = s), e.previousSibling_ = e.nextSibling_ = e.parentNode_ = void 0
            } else m(this), Z(P(this), i);
            return B || N(this, "childList", {removedNodes: n(e), nextSibling: a, previousSibling: s}), H(this, e), e
        }, replaceChild: function (e, r) {
            t(e);
            var o;
            if (C(r) ? o = W(r) : (o = r, r = I(o)), r.parentNode !== this)throw new Error("NotFoundError");
            var s, c = r.nextSibling, u = r.previousSibling, d = !this.invalidateShadowRenderer() && !v(e);
            return d ? s = a(e) : (c === e && (c = e.nextSibling), s = i(e, this, u, c)), d ? (f(this, e), m(this), Y.call(P(this), W(e), o)) : (this.firstChild === r && (this.firstChild_ = s[0]), this.lastChild === r && (this.lastChild_ = s[s.length - 1]), r.previousSibling_ = r.nextSibling_ = r.parentNode_ = void 0, o.parentNode && Y.call(o.parentNode, w(this, s), o)), N(this, "childList", {
                addedNodes: s,
                removedNodes: n(r),
                nextSibling: c,
                previousSibling: u
            ...
            return void 0 !== this.parentNode_ ? this.parentNode_ : I(P(this).parentNode)
        }, get firstChild() {
            return void 0 !== this.firstChild_ ? this.firstChild_ : I(P(this).firstChild)
        }, get lastChild() {
            return void 0 !== this.lastChild_ ? this.lastChild_ : I(P(this).lastChild)
        }, get nextSibling() {
            return void 0 !== this.nextSibling_ ? this.nextSibling_ : I(P(this).nextSibling)
        }, get previousSibling() {
            return void 0 !== this.previousSibling_ ? this.previousSibling_ : I(P(this).previousSibling)
        }, get parentElement() {
            ...
            N(this, "childList", {addedNodes: r, removedNodes: t}), d(t), l(r, this)
        }, get childNodes() {
    ...
    function d(n, r, o, i, a) {
        ...
        if (c instanceof N)s = M.call(c, i); else {
    ...
    function f(n, r, o, i, a) {
        ...
        if (c instanceof N)s = O.call(c, i, a); else {
    ...
    function h(n, r, o, i, a) {
        var s, c = v(this), u = g(this).root;
        if (u instanceof e.wrappers.ShadowRoot)return p(this, r, o, n, i, a);
        if (c instanceof N)s = j.call(c, i, a); else {
            if (!(c instanceof _))return p(this, r, o, n, i, a);
            s = L.call(c, i, a)
        }
        return t(s, r, o, !1)
    ...
    function i(e, t) {
        switch (e.nodeType) {
            case Node.ELEMENT_NODE:
                for (var o, i = e.tagName.toLowerCase(), s = "<" + i, c = e.attributes, u = 0; o = c[u]; u++)s += " " + o.name + '="' + n(o.value) + '"';
                return s += ">", N[i] ? s : s + a(e) + "</" + i + ">";
            case Node.TEXT_NODE:
                var l = e.data;
                return t && _[t.localName] ? l : r(l);
    ...
    function s(e, t, n) {
        var r = n || "div";
        e.textContent = "";
        var o = M(e.ownerDocument.createElement(r));
        o.innerHTML = t;
    ...
    function u(e, t) {
        var n = M(e.cloneNode(!1));
        n.innerHTML = t;
        for (var r, o = M(document.createDocumentFragment()); r = n.firstChild;)o.appendChild(r);
        return T(o)
    }
    ...
    var h = e.wrappers.Element, w = e.defineGetter, m = e.enqueueMutation, g = e.mixin, v = e.nodesWereAdded, b = e.nodesWereRemoved, y = e.registerWrapper, E = e.snapshotNodeList, S = e.unsafeUnwrap, M = e.unwrap, T = e.wrap, O = e.wrappers, L = /[&\u00A0"]/g, j = /[&\u00A0<>]/g, N = o(["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"]), _ = o(["style", "script", "xmp", "iframe", "noembed", "noframes", "plaintext", "noscript"]), C = /MSIE/.test(navigator.userAgent), D = window.HTMLElement, H = window.HTMLTemplateElement;
    c.prototype = Object.create(h.prototype), g(c.prototype, {
        get innerHTML() {
            return a(this)
        }, set innerHTML(e) {
            if (C && _[this.localName])return void(this.textContent = e);
            var t = E(this.childNodes);
            this.invalidateShadowRenderer() ? this instanceof O.HTMLTemplateElement ? s(this.content, e) : s(this, e, this.tagName) : !H && this instanceof O.HTMLTemplateElement ? s(this.content, e) : S(this).innerHTML = e;
            var n = E(this.childNodes);
            m(this, "childList", {addedNodes: n, removedNodes: t}), b(t), v(n, this)
        }, get outerHTML() {
    ...
    if (!("classList"in a)) {
        var u = Object.getOwnPropertyDescriptor(t.prototype, "classList");
        Object.defineProperty(n.prototype, "classList", u), delete t.prototype.classList
    }
    ...
    if (c) {
        ...
        var u = /WebKit/.test(navigator.userAgent) ? {drawingBufferHeight: null, drawingBufferWidth: null} : {};
    ...
    var n = e.wrappers.DocumentFragment, r = e.TreeScope, o = e.elementFromPoint, i = e.getInnerHTML, a = e.getTreeScope, s = e.mixin, c = e.rewrap, u = e.setInnerHTML, l = e.unsafeUnwrap, p = e.unwrap, d = new WeakMap, f = new WeakMap, h = /[ \t\n\r\f]/;
    ...
    function u(e) {
        var t = I.get(e);
        return t || (t = new f(e), I.set(e, t)), t
    }
    ...
    function E(e) {
        return e instanceof L || e instanceof j
    }
    ...
    B.equals = function (e, t) {
        ...
        render: function (e) {
            ...
            if (!(e instanceof j))if (e instanceof L) {
                var n = e;
    ...
    }, L.prototype.getDistributedNodes = j.prototype.getDistributedNodes = function () {
        return s(), i(this)
    }, O.prototype.getDestinationInsertionPoints = function () {
        return s(), g(this) || []
    }, L.prototype.nodeIsInserted_ = j.prototype.nodeIsInserted_ = function () {
    ...
    "use strict";
    function t(e) {
        l.call(this, e), this.treeScope_ = new w(this, null)
    }

    function n(e) {
        var n = document[e];
        t.prototype[e] = function () {
            return N(n.apply(L(this), arguments))
        }
    }

    function r(e, t) {
        D.call(L(t), j(e)), o(e, t)
    }
    ...
    var u = e.GetElementsByInterface, l = e.wrappers.Node, p = e.ParentNodeInterface, d = e.wrappers.Selection, f = e.SelectorsInterface, h = e.wrappers.ShadowRoot, w = e.TreeScope, m = e.cloneNode, g = e.defineWrapGetter, v = e.elementFromPoint, b = e.forwardMethodsToWrapper, y = e.matchesNames, E = e.mixin, S = e.registerWrapper, M = e.renderAllPending, T = e.rewrap, O = e.setWrapper, L = e.unsafeUnwrap, j = e.unwrap, N = e.wrap, _ = e.wrapEventTargetMethods, C = (e.wrapNodeList, new WeakMap);
    t.prototype = Object.create(l.prototype), g(t, "documentElement"), g(t, "body"), g(t, "head"), ["createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "getElementById"].forEach(n);
    ...
    if (E(t.prototype, {
            adoptNode: function (e) {
                ...
                return v(this, this, e, t)
            }, importNode: function (e, t) {
                return m(e, t, L(this))
            }, getSelection: function () {
                return M(), new d(H.call(j(this)))
    ...
    b([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"]), b([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], y), b([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), E(t.prototype, u), E(t.prototype, p), E(t.prototype, f), E(t.prototype, {
        get implementation() {
            var e = C.get(this);
            return e ? e : (e = new a(j(this).implementation), C.set(this, e), e)
        }, get defaultView() {
            return N(j(this).defaultView)
        }
