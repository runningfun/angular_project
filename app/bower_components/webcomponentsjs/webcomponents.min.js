...
window.WebComponents = window.WebComponents || {}, function (e) {
        ...
        for (var o = W(t), i = 0; i < o.length; i++) {
            ...
            if ("polymerBlackList_" !== a && !(a in n || t.polymerBlackList_ && t.polymerBlackList_[a])) {
                ...
                if (r && "function" == typeof l.value)n[a] = h(a); else {
                    ...
                    k(n, a, {get: s, set: c, configurable: w, enumerable: l.enumerable})
                }
            }
        }
    }
    ...
    function g(e, t, r) {
        var o = t.prototype;
        n(void 0 === R.get(e)), R.set(e, t), P.set(o, e), c(e, o), r && l(o, r), a(o, "constructor", t), t.prototype = o
    }
    ...
    n.prototype = {
        calcEditDistances: function (e, t, n, r, o, i) {
            ...
            if (0 == n && 0 == l && (d = this.sharedPrefix(e, c, f)), s == e.length && u == c.length && (p = this.sharedSuffix(e, c, f - d)), n += d, l += d, s -= p, u -= p, s - n == 0 && u - l == 0)return [];
            if (n == s) {
    ...
    function h(t, n) {
        ...
        return nt.set(t, o), m(t, o, a, i) && w(t, o, a, i) && v(t, o, a, i), Z.set(t, rt), $["delete"](t, null), Y["delete"](t), t.defaultPrevented
    }
    ...
    function y(e, t) {
        ...
        var n = e;
        return gt || "beforeunload" !== n.type || this instanceof _ ? void B(n, this) : new _(n)
    }
    ...
    }, dt = W({initMouseEvent: T("initMouseEvent", 14)}, ut), pt = W({initFocusEvent: T("initFocusEvent", 5)}, ut), ft = S("MouseEvent", ct, dt), ht = S("FocusEvent", ct, pt), mt = Object.create(null), wt = function () {
        try {
    ...
    _.prototype = Object.create(y.prototype), W(_.prototype, {
        get returnValue() {
    ...
    e.elementFromPoint = x, e.getEventHandlerGetter = R, e.getEventHandlerSetter = P, e.wrapEventTargetMethods = H, e.wrappers.BeforeUnloadEvent = _, e.wrappers.CustomEvent = lt, e.wrappers.Event = y, e.wrappers.EventTarget = C, e.wrappers.FocusEvent = ht, e.wrappers.MouseEvent = ft, e.wrappers.UIEvent = ct
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e, t) {
    ...
    function r(e, t, n) {
        C(t, "childList", {removedNodes: n, previousSibling: e.previousSibling, nextSibling: e.nextSibling})
    }

    function o(e, t) {
        C(e, "childList", {removedNodes: t})
    }
    ...
    function u(e, t) {
        for (var n = N(t), r = 0; r < e.length; r++)l(e[r], n)
    }
    ...
    function v(e) {
        ...
        } else for (var n, i = I(e), a = i.firstChild; a;)n = a.nextSibling, Y.call(i, a), a = n
    }
    ...
    function E(e, t) {
        if (!t || N(e) !== N(t))return !1;
        for (var n = t; n; n = n.parentNode)if (n === e)return !0;
        return !1
    }

    function S(e) {
        L(e instanceof V), T.call(this, e), this.parentNode_ = void 0, this.firstChild_ = void 0, this.lastChild_ = void 0, this.nextSibling_ = void 0, this.previousSibling_ = void 0, this.treeScope_ = void 0
    }

    var T = e.wrappers.EventTarget, M = e.wrappers.NodeList, _ = e.TreeScope, L = e.assert, O = e.defineWrapGetter, C = e.enqueueMutation, N = e.getTreeScope, D = e.isWrapper, j = e.mixin, H = e.registerTransientObservers, x = e.registerWrapper, R = e.setTreeScope, P = e.unsafeUnwrap, I = e.unwrap, A = e.unwrapIfNeeded, k = e.wrap, W = e.wrapIfNeeded, F = e.wrappers, B = !1, U = document.importNode, q = window.Node.prototype.cloneNode, V = window.Node, G = window.DocumentFragment, z = (V.prototype.appendChild, V.prototype.compareDocumentPosition), K = V.prototype.insertBefore, Y = V.prototype.removeChild, X = V.prototype.replaceChild, $ = /Trident|Edge/.test(navigator.userAgent), J = $ ? function (e, t) {
        try {
            Y.call(e, t)
        } catch (n) {
    ...
    S.prototype = Object.create(T.prototype), j(S.prototype, {
        appendChild: function (e) {
            ...
            t(e);
            var r;
            n ? D(n) ? r = I(n) : (r = n, n = k(r)) : (n = null, r = null), n && L(n.parentNode === this);
            ...
            return C(this, "childList", {addedNodes: o, nextSibling: n, previousSibling: s}), u(o, this), e
            ...
            return B || C(this, "childList", {removedNodes: n(e), nextSibling: a, previousSibling: s}), H(this, e), e
            ...
            return p ? s = a(e) : (c === e && (c = e.nextSibling), s = i(e, this, l, c)), p ? (f(this, e), w(this), X.call(P(this), I(e), o)) : (this.firstChild === r && (this.firstChild_ = s[0]), this.lastChild === r && (this.lastChild_ = s[s.length - 1]), r.previousSibling_ = r.nextSibling_ = r.parentNode_ = void 0, o.parentNode && X.call(o.parentNode, m(this, s), o)), C(this, "childList", {
                addedNodes: s,
                removedNodes: n(r),
                nextSibling: c,
                previousSibling: l
            ...
            C(this, "childList", {addedNodes: r, removedNodes: t}), p(t), u(r, this)
        }, get childNodes() {
    ...
    function p(n, r, o, i, a) {
        ...
        if (c instanceof C)s = T.call(c, i); else {
            if (!(c instanceof N))return d(this, r, o, n, i, null);
            s = S.call(c, i)
        }
        return t(s, r, o, a)
    }
    ...
    function f(n, r, o, i, a) {
        ...
        if (c instanceof C)s = _.call(c, i, a); else {
            if (!(c instanceof N))return d(this, r, o, n, i, a);
            s = M.call(c, i, a)
        }
        return t(s, r, o, !1)
    }
    ...
    function h(n, r, o, i, a) {
        var s, c = g(this), l = v(this).root;
        if (l instanceof e.wrappers.ShadowRoot)return d(this, r, o, n, i, a);
        if (c instanceof C)s = O.call(c, i, a); else {
            if (!(c instanceof N))return d(this, r, o, n, i, a);
            s = L.call(c, i, a)
        }
        return t(s, r, o, !1)
    ...
    var m = e.wrappers.HTMLCollection, w = e.wrappers.NodeList, v = e.getTreeScope, g = e.unsafeUnwrap, b = e.wrap, y = document.querySelector, E = document.documentElement.querySelector, S = document.querySelectorAll, T = document.documentElement.querySelectorAll, M = document.getElementsByTagName, _ = document.documentElement.getElementsByTagName, L = document.getElementsByTagNameNS, O = document.documentElement.getElementsByTagNameNS, C = window.Element, N = window.HTMLDocument || window.Document, D = "http://www.w3.org/1999/xhtml", j = {
        querySelector: function (t) {
            var r = n(t), i = r !== t;
            t = r;
            var a, s = g(this), c = v(this).root;
            if (c instanceof e.wrappers.ShadowRoot)return o(this, t);
            if (s instanceof C)a = b(E.call(s, t)); else {
                if (!(s instanceof N))return o(this, t);
                a = b(y.call(s, t))
            }
        ...
        getElementsByTagName: function (e) {
            ...
            var n = new m, r = null;
            return r = "*" === e ? "*" === t ? s : c : "*" === t ? l : u, n.length = h.call(this, r, 0, n, e || null, t), n
        }
    };
    e.GetElementsByInterface = x, e.SelectorsInterface = j, e.MatchesInterface = H
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e) {
    ...
    function i(e, t) {
        switch (e.nodeType) {
            case Node.ELEMENT_NODE:
                ...
                return s += ">", C[i] ? s : s + a(e) + "</" + i + ">";
            case Node.TEXT_NODE:
                var u = e.data;
                return t && N[t.localName] ? u : r(u);
    ...
    function a(e) {
        e instanceof _.HTMLTemplateElement && (e = e.content);
    ...
    var h = e.wrappers.Element, m = e.defineGetter, w = e.enqueueMutation, v = e.mixin, g = e.nodesWereAdded, b = e.nodesWereRemoved, y = e.registerWrapper, E = e.snapshotNodeList, S = e.unsafeUnwrap, T = e.unwrap, M = e.wrap, _ = e.wrappers, L = /[&\u00A0"]/g, O = /[&\u00A0<>]/g, C = o(["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"]), N = o(["style", "script", "xmp", "iframe", "noembed", "noframes", "plaintext", "noscript"]), D = /MSIE/.test(navigator.userAgent), j = window.HTMLElement, H = window.HTMLTemplateElement;
    c.prototype = Object.create(h.prototype), v(c.prototype, {
        get innerHTML() {
            return a(this)
        }, set innerHTML(e) {
            if (D && N[this.localName])return void(this.textContent = e);
            var t = E(this.childNodes);
            this.invalidateShadowRenderer() ? this instanceof _.HTMLTemplateElement ? s(this.content, e) : s(this, e, this.tagName) : !H && this instanceof _.HTMLTemplateElement ? s(this.content, e) : S(this).innerHTML = e;
    ...
    function E(e) {
        return e instanceof L || e instanceof O
    }
    ...
    B.equals = function (e, t) {
        ...
        render: function (e) {
            ...
            if (!(e instanceof O))if (e instanceof L) {
                var n = e;
    ...
    }, L.prototype.getDistributedNodes = O.prototype.getDistributedNodes = function () {
        return s(), i(this)
    }, _.prototype.getDestinationInsertionPoints = function () {
        return s(), v(this) || []
    }, L.prototype.nodeIsInserted_ = O.prototype.nodeIsInserted_ = function () {
        this.invalidateShadowRenderer();
        var e, t = u(this);
        t && (e = d(t)), H(this).polymerShadowRenderer_ = e, e && e.invalidate()
    }, e.getRendererForHost = l, e.getShadowTrees = T, e.renderAllPending = s, e.getDestinationInsertionPoints = v, e.visual = {
        insertBefore: n,
        remove: r
    }
}(window.ShadowDOMPolyfill), function (e) {
    ...
    if (E(t.prototype, {
        ...
        t.prototype.registerElement = function (t, n) {
            function r(e) {
                return e ? void _(e, this) : i ? document.createElement(i, t) : document.createElement(t)
            }
    ...
    b([window.HTMLBodyElement, window.HTMLDocument || window.Document, window.HTMLHeadElement, window.HTMLHtmlElement], ["appendChild", "compareDocumentPosition", "contains", "getElementsByClassName", "getElementsByTagName", "getElementsByTagNameNS", "insertBefore", "querySelector", "querySelectorAll", "removeChild", "replaceChild"]), b([window.HTMLBodyElement, window.HTMLHeadElement, window.HTMLHtmlElement], y), b([window.HTMLDocument || window.Document], ["adoptNode", "importNode", "contains", "createComment", "createDocumentFragment", "createElement", "createElementNS", "createEvent", "createEventNS", "createRange", "createTextNode", "elementFromPoint", "getElementById", "getElementsByName", "getSelection"]), E(t.prototype, l), E(t.prototype, d), E(t.prototype, f), E(t.prototype, {
        get implementation() {
            var e = D.get(this);
            return e ? e : (e = new a(O(this).implementation), D.set(this, e), e)
        }, get defaultView() {
            return C(O(this).defaultView)
        }
    ...
    function o() {
        N.initialized = !0, document.body.appendChild(N);
        var e = N.contentDocument, t = e.createElement("base");
        t.href = document.baseURI, e.head.appendChild(t)
    }

    function i(e) {
        N.initialized || o(), document.body.appendChild(N), e(N.contentDocument), document.body.removeChild(N)
    }
    ...
    function l() {
        return D || (D = document.createElement("style"), D.setAttribute(x, ""), D[x] = !0), D
    }
    ...
    var u = {
        strictStyling: !1, registry: {}, shimStyling: function (e, n, r) {
            ...
            for (var t = 0; t < C.length; t++)e = e.replace(C[t], " ");
            return e
            ...
            return o.forEach(function (e) {
                e = e.trim(), this.selectorNeedsScoping(e, t) && (e = n && !e.match(L) ? this.applyStrictSelectorScope(e, t) : this.applySelectorScope(e, t)), r.push(e)
            }, this), r.join(", ")
            ...
            return e.match(O) ? (e = e.replace(L, t), e.replace(O, t + " ")) : t + " " + e
    ...
    function i(e, t) {
        ...
        if (c)for (var l, u = 0; c > u && (l = i[u]); u++)a(l) ? r.call(l, {target: l}) : (l.addEventListener("load", r), l.addEventListener("error", r)); else n()
    }
    ...
    }), e.IMPORT_LINK_TYPE = u, e.useNative = d, e.rootDocument = h, e.whenReady = t, e.isIE = w
    ...
    }, f = new l(p.loaded.bind(p), p.loadedAll.bind(p));
    if (p.observer = new u, !document.baseURI) {
        ...
        Object.defineProperty(document, "baseURI", h), Object.defineProperty(c, "baseURI", h)
    }
    e.importer = p, e.importLoader = f
}), HTMLImports.addModule(function (e) {
    ...
    var T = !1, M = [], _ = Array.prototype.forEach.call.bind(Array.prototype.forEach), L = Element.prototype.createShadowRoot;
    L && (Element.prototype.createShadowRoot = function () {
        var e = L.call(this);
        return CustomElements.watchShadow(this), e
    }), e.watchShadow = f, e.upgradeDocumentTree = g, e.upgradeSubtree = r, e.upgradeAll = t, e.attachedNode = o, e.takeRecords = m
}), CustomElements.addModule(function (e) {
    function t(t) {
    ...
    function t(t, r) {
        ...
        return c.prototype || (c.prototype = Object.create(HTMLElement.prototype)), c.__name = t.toLowerCase(), c.lifecycle = c.lifecycle || {}, c.ancestry = i(c["extends"]), a(c), s(c), n(c.prototype), u(c.__name, c), c.ctor = d(c), c.ctor.prototype = c.prototype, c.prototype.constructor = c.ctor, e.ready && w(document), c.ctor
    }
    ...
    m = Object.__proto__ || y ? function (e, t) {
        ...
        return !1
    }, document.registerElement = t, document.createElement = f, document.createElementNS = p, Node.prototype.cloneNode = h, e.registry = S, e["instanceof"] = m, e.reservedTagList = E, e.getRegisteredDefinition = l, document.register = document.registerElement
}), function (e) {
    function t() {
