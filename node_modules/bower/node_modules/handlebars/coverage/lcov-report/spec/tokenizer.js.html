...
<div class="header low">
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">spec/</a> &#187; tokenizer.js
    </div>
</div>
<div class="body">
<pre><table class="coverage">
    <tr>
        ...
        <td class="text"><pre class="prettyprint lang-js"><span class="fstat-no" title="function not covered">function shouldMatchTokens(result, tokens) {</span>
...
<span class="cstat-no"
      title="statement not covered">      if (!result || result === 'EOF' || result === 'INVALID') {</span>
...
&nbsp;
  it('tokenizes a simple mustache as "OPEN ID CLOSE"', <span class="fstat-no"
...
&nbsp;
  it('supports escaping multiple escape characters', <span class="fstat-no"
                                                           title="function not covered">function() {</span>
<span class="cstat-no"
      title="statement not covered">    var result = tokenize("{{foo}} \\\\{{bar}} \\\\{{baz}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'CLOSE', 'CONTENT', 'OPEN', 'ID', 'CLOSE', 'CONTENT', 'OPEN', 'ID', 'CLOSE']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[3], "CONTENT", " \\");</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[5], "ID", "bar");</span>
...
&nbsp;
  it('allows multiple path literals on a line with []', <span class="fstat-no"
                                                              title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes a path as "OPEN (ID SEP)* ID CLOSE"', <span class="fstat-no"
                                                            title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{../foo/bar}}");</span>
...
&nbsp;
  it('tokenizes a path with .. as a parent path', <span class="fstat-no"
                                                        title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{../foo.bar}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'SEP', 'ID', 'SEP', 'ID', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[1], "ID", "..");</span>
...
&nbsp;
  it('tokenizes a simple mustache with line breaks as "OPEN ID ID CLOSE"', <span class="fstat-no"
                                                                                 title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{  foo  \n   bar }}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'ID', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[1], "ID", "foo");</span>
  });
&nbsp;
...
&nbsp;
  it('tokenizes a partial as "OPEN_PARTIAL ID CLOSE"', <span class="fstat-no"
                                                             title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt; foo}}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'CLOSE']);</span>
  });
&nbsp;
  it('tokenizes a partial with context as "OPEN_PARTIAL ID ID CLOSE"', <span class="fstat-no"
                                                                             title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt; foo bar }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'ID', 'CLOSE']);</span>
  });
&nbsp;
  it('tokenizes a partial without spaces as "OPEN_PARTIAL ID CLOSE"', <span class="fstat-no"
                                                                            title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt;foo}}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'CLOSE']);</span>
...
&nbsp;
  it('tokenizes a partial space at the }); as "OPEN_PARTIAL ID CLOSE"', <span class="fstat-no"
                                                                              title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt;foo  }}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'CLOSE']);</span>
...
<span class="cstat-no"
      title="statement not covered">    shouldBeToken(result[1], "COMMENT", " this is a comment ");</span>
  });
&nbsp;
...
&nbsp;
  it('tokenizes open and closing blocks as OPEN_BLOCK, ID, CLOSE ..., OPEN_ENDBLOCK ID CLOSE', <span class="fstat-no"
                                                                                                     title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes inverse sections with ID as "OPEN_INVERSE ID CLOSE"', <span class="fstat-no"
                                                                            title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{^foo}}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN_INVERSE', 'ID', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[1], "ID", "foo");</span>
  });
&nbsp;
  it('tokenizes inverse sections with ID and spaces as "OPEN_INVERSE ID CLOSE"', <span class="fstat-no"
                                                                                       title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{^ foo  }}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN_INVERSE', 'ID', 'CLOSE']);</span>
...
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo bar baz }}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'ID', 'ID', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[1], "ID", "foo");</span>
...
&nbsp;
  it('tokenizes mustaches with String params as "OPEN ID ID STRING CLOSE"', <span class="fstat-no"
                                                                                  title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo bar \"baz\" }}");</span>
...
&nbsp;
  it('tokenizes mustaches with String params using single quotes as "OPEN ID ID STRING CLOSE"', <span class="fstat-no"
                                                                                                      title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo bar \'baz\' }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'ID', 'STRING', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[3], "STRING", "baz");</span>
...
<span class="cstat-no" title="statement not covered">    var result = tokenize('{{ foo "bar\\"baz" }}');</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'STRING', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[2], "STRING", 'bar"baz');</span>
  });
&nbsp;
  it('tokenizes String params using single quotes with escapes quotes as STRING', <span class="fstat-no"
                                                                                        title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo 'bar\\'baz' }}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'STRING', 'CLOSE']);</span>
...
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'NUMBER', 'CLOSE']);</span>
...
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'BOOLEAN', 'CLOSE']);</span>
...
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ @foo }}");</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'DATA', 'ID', 'CLOSE']);</span>
...
&nbsp;
  it('does not time out in a mustache with a single } followed by EOF', <span class="fstat-no"
                                                                              title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(tokenize("{{foo}"), ['OPEN', 'ID']);</span>
  });
&nbsp;
  it('does not time out in a mustache when invalid ID characters are used', <span class="fstat-no"
                                                                                  title="function not covered">function() {</span>
<span class="cstat-no"
      title="statement not covered">    shouldMatchTokens(tokenize("{{foo &amp; }}"), ['OPEN', 'ID']);</span>
  });
&nbsp;
...
&nbsp;
  it('tokenizes nested subexpressions: literals', <span class="fstat-no"
                                                        title="function not covered">function() {</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Aug 13 2014
        23:50:21 GMT-0500 (CDT)
    </div>
</div>
