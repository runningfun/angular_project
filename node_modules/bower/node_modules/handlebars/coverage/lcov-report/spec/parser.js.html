...
<pre><table class="coverage">
    <tr>
        ...
        <td class="text"><pre class="prettyprint lang-js">/*global Handlebars */
...
<span class="cstat-no"
      title="statement not covered">    equals(ast_for("{{foo/bar}}"), "{{ PATH:foo/bar [] }}\n");</span>
  });
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">    equals(ast_for("{{foo bar}}"), "{{ ID:foo [ID:bar] }}\n");</span>
  });
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">    equals(ast_for("{{foo 1}}"), "{{ ID:foo [NUMBER{1}] }}\n");</span>
  });
&nbsp;
...
<span class="cstat-no"
      title="statement not covered">    equals(ast_for("{{&gt; foo }}"), "{{&gt; PARTIAL:foo }}\n");</span>
  });
&nbsp;
...
&nbsp;
  it('parses empty blocks with empty inverse section', <span class="fstat-no"
...
&nbsp;
  it('parses non-empty blocks with empty inverse (else-style) section', <span class="fstat-no"
                                                                              title="function not covered">function() {</span>
...
&nbsp;
  it('parses empty blocks with non-empty inverse (else-style) section', <span class="fstat-no"
                                                                              title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">    shouldThrow(<span class="fstat-no"
...
&nbsp;
  it('knows how to report the correct line number in errors when the first character is a newline', <span
                class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldThrow(<span class="fstat-no"
                                                                           title="function not covered">function() {</span></span>
...
&nbsp;
  describe('externally compiled AST', function() {
    it('can pass through an already-compiled AST', <span class="fstat-no"
                                                         title="function not covered">function() {</span>
