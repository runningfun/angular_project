...
<div class="header low">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">spec/env/</a> &#187;
        runtime.js
    </div>
</div>
<div class="body">
<pre><table class="coverage">
    <tr>
        ...
        <td class="text"><pre class="prettyprint lang-js">/*global handlebarsEnv */
require('./common');
&nbsp;
...
<span class="cstat-no" title="statement not covered">    handlebarsEnv.precompile = <span class="fstat-no"
                                                                                          title="function not covered">function(template, options) {</span></span>
<span class="cstat-no"
      title="statement not covered">      return compiler.precompile(template, options, handlebarsEnv);</span>
    };
...
&nbsp;
<span class="cstat-no"
      title="statement not covered">    var templateSpec = handlebarsEnv.precompile(template, options);</span>
<span class="cstat-no" title="statement not covered">    return handlebarsEnv.template(safeEval(templateSpec));</span>
  ...
  compileWithPartial: <span class="fstat-no" title="function not covered">function(template, options) {</span>
    // Hack the compiler on to the environment for these specific tests
<span class="cstat-no" title="statement not covered">    handlebarsEnv.compile = <span class="fstat-no"
                                                                                       title="function not covered">function(template, options) {</span></span>
<span class="cstat-no"
      title="statement not covered">      return compiler.compile(template, options, handlebarsEnv);</span>
    };
<span class="cstat-no" title="statement not covered">    handlebarsEnv.parse = parse;</span>
<span class="cstat-no" title="statement not covered">    handlebarsEnv.Compiler = compiler.Compiler;</span>
<span class="cstat-no" title="statement not covered">    handlebarsEnv.JavaScriptCompiler = JavaScriptCompiler;</span>
